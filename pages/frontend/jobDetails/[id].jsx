                            ...
                            <div className='flex items-center  justify-center w-full py-10'>
                                <div className='flex w-full px-8 md:px-20 items-start md:flex-row flex-col md:justify-between justify-center'>
                                    <div className='flex mb-1 items-center justify-center'>
                                        <Image src={"https://i.ibb.co/hggfdPW/user1.png"} alt="no-image" className='rounded-full mb-2' width={100} height={100} />
                                    ...
                                    <div className='flex items-center justify-center'>
                                        {
                                            JobDetails?.user?.email === user?.email ? (
                                                ...
                                                <div className='flex items-center justify-center  '>
                                                    ...
                                                    <button onClick={handleApply} className='md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 bg-orange-500 rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-indigo-900 text-white  '>Apply Position</button>
                                                </div>
                                            )
                                        }
                                    </div>

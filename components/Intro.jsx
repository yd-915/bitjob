      ...
      <div className='w-full  h-full flex items-center lg:justify-start py-24 justify-center flex-wrap  '>
        <div className='lg:w-3/6 w-full sm:p-2 h-full my-2 flex items-center justify-center px-4 md:items-start md:justify-start md:p-20 flex-col '>
          <h1 className='md:text-6xl text-2xl sm:text-2xl font-extrabold mb-4 text-black'>Halal Jobs <span className='text-indigo-600'>for Halal Money.</span> </h1>
           <p className='md:text-lg sm:text-sm text-xs mb-20 text-gray-400'>Find/Post jobs that don't compromise your Islamic values and pays you with Bitcoin. The strongest Halal currency today!</p>
          ...
          <div className=' w-full px-2 py-2 flex items-center justify-start flex-wrap'>
            ...
            <div className='flex   items-center justify-center px-4 flex-wrap'>
              <p className='px-2  text-indigo-600'>Software</p>
              <p className='px-2  text-indigo-600'>Marketing</p>
              <p className='px-2  text-indigo-600'>Sales</p>
              <p className='px-2  text-indigo-600'>And more</p>
            </div>
          </div>
        </div>
